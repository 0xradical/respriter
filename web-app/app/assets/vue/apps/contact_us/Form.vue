<template>
  <div
    class="clspt:contact-us__form container mT24 mB48 mT32@>lg mB64@>lg"
  >
    <div class="row mB20 mB32@>lg">
      <div class="col ta-c">
        <div class="mB8 mB16@>lg">
          <span
            class="fs24 fs32@>lg fw-b c-fg"
            >{{ $t("contact_us.new.title") }}</span
          >
        </div>
        <div>
          <span class="fs16 c-fgM">{{
    ...
    <validation-observer v-slot="{ invalid, validate }" tag="div">
      <form @submit.prevent="validate().then(submit)" class="row">
        ...
        <validation-provider
          ...
          class="col-md-12 offset-lg-4 col-lg-4 mB32"
        >
            ...
            >
              ...
              >
                ...
                <icon
                  ...
                  class="el:m-form-field__input-icon fi-err"
                  name="error"
                  width="1.125em"
                  height="1.125em"
                ></icon>
                <icon
                  ...
                  class="el:m-form-field__input-icon fi1"
                  name="checked"
                  width="1.125em"
                  height="1.125em"
                ></icon>
        ...
        <validation-provider
          ...
          name="message"
          rules="required"
          class="col-md-12 offset-lg-4 col-lg-4 mB20"
        >
          <template #default="{ errors }">
            <div
              class="el:m-form-field"
        ...
        <validation-provider
          tag="div"
          name="challenge"
          :rules="`required|challenge:${mathenticate.first},${mathenticate.second}`"
          class="col-md-12 offset-lg-4 col-lg-4 mB32"
        >
          <template #default="{ errors }">
            <div
        ...
        <div class="col-md-12 offset-lg-6 col-lg-2">
          <button
            ...
            class="el:m-button el:m-button--block el:m-button--primary-flat"
          >
