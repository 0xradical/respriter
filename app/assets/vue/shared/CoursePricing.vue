<template>
  <div :class="[...rootClassesBase, ...rootClasses]">
    <span class='el:amx-Tt(u) el:amx-Mb(0.25em) el:amx-Ta(r)' v-if="course.subscription_type && trialCallout">
      ...
      <span class='el:amx-C_white el:amx-Bc_green el:amx-Fw(b) el:amx-Pr(0.25em) el:amx-Pl(0.25em) el:amx-Pt(0.125em) el:amx-Pb(0.125em) el:amx-Fs(0.625em) el:amx-Ws(nr)'>
