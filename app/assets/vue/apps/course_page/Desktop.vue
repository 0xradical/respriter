    ...
    <div class="el:amx-Pt(4em) el:amx-Pb(4em)">
      <div class="container">
        <div class="row">
          ...
          <div class="col-4">
            <div
              class="el:amx-Bc_white el:amx-Pt(1.5em) el:amx-Pr(1.5em) el:amx-Pb(0.375em) el:amx-Pl(1.5em)"
            >
...
export default {
  ...
  components: {
    ...
    CourseProvider: () =>
      import(
        /* webpackChunkName: "course-provider" */ "../../shared/CourseProvider.vue"
      ),
    CourseTitle,
    CourseButton,
    CourseSocialSharing,
    CourseDescription: () =>
      import(
        /* webpackChunkName: "course-description" */ "../../shared/CourseDescription.vue"
      ),
    CourseTags: () =>
      import(
        /* webpackChunkName: "course-tags" */ "../../shared/CourseTags.vue"
      ),
    CoursePricing,
    CourseAttributeList: () =>
      import(
        /* webpackChunkName: "course-attribute-list" */ "../../shared/CourseAttributeList.vue"
      )
  }
};
</script>
