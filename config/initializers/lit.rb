...
Lit.authentication_function = :authenticate_admin_account!
...
# Lit.storage_options = { prefix: 'lit' }
...
class Sprockets::Environment
  def append_path(path)
    return if path.match(/^#{Rails.root.join 'app/assets'}/)
    super path
  end
end
